...
// 1. Print the official name of the country
console.log(indiaDetails[0].name.official);

// 2. What is the capital of the Republic of India?
console.log(indiaDetails[0].capital[0]);

// 3. What is the population of the British Indian Ocean Territory?
console.log(indiaDetails[0].population);

// 4. List the neighboring countries of the Republic of India.
console.log(indiaDetails[0].borders);

// 5. What is the currency used in the British Indian Ocean Territory?
console.log(indiaDetails[0].currencies.INR.name);

// 6. Print the common name of the official language spoken in the Republic of India.
console.log(indiaDetails[0].languages);

// 7. What continent is the British Indian Ocean Territory located in?
console.log(indiaDetails[0].continents[0]);

// 8. Provide the Google Maps link for the Republic of India.
console.log(indiaDetails[0].maps.googleMaps);
