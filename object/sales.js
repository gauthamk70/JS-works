...
var lowestSale  = Object.entries(productSales).reduce((it1,it2)=>it1[1]>it2[1]?it2:it1)
...
var totalSold = Object.entries(productSales).reduce((sum,item)=>sum+item[1],0)
console.log("Total items sold: ",totalSold);
